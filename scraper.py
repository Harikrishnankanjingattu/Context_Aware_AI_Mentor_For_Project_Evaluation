...
def search_and_save_papers(topic, all_papers_path, ieee_papers_path):
    """
    Search academic APIs for papers on a topic, deduplicate, filter for IEEE,
    and save both sets to the specified CSV paths.
    """
    all_results = []
    ...
    save_to_csv(all_results, all_papers_path)
    save_to_csv(ieee_results, ieee_papers_path)
    return all_results, ieee_results
...
def main():
    ...
    search_and_save_papers(topic, "all_papers.csv", "ieee_papers.csv")
